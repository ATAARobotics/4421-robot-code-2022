...
public class RobotMap {
    ...
    public static final double VISION_TARGET_TOLERANCE = 0.0523; // This isn't a magic number - it's the central angle
                                                                 // given from an arc length of 8 inches at a radius of
                                                                 // 204 inches
