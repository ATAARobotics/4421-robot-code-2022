...
public class RobotMap {
    ...
    public static final int[] CLIMB_CLAMPS = { 99, 99 }; //TODO: Change to real ports
    ...
    public static final boolean FIELD_ORIENTED = false; /*****THIS CAN'T BE TRUE IF YOU WANT AUTO TO WORK RIGHT*****/
