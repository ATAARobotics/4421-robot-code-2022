...
public class SwerveModule {
  ...
  private static final double kModuleMaxAngularAcceleration =
      ...
      private CANCoder m_rotationEncoder;
   ...
   * @param angleController The input from the encoder
   */
  // public SwerveModule(
  ...
  //     int turningEncoderChannelB, PIDController angleController) {
  ...
  //   // encoder resolution.
  //   m_rotationEncoder.getAbsolutePosition();
  ...
  public SwerveModule(int i, int j, CANCoder canCoder, double d, boolean b, double e, int k, String string) {
    m_driveMotor = new TalonFX(i);
   ...
   // m_driveEncoder.setDistancePerPulse(2 * Math.PI * kWheelRadius / kEncoderResolution);
    ...
    // This is the the angle through an entire rotation (2 * pi) divided by the
    // encoder resolution.
   // m_rotationEncoder.setDistancePerPulse(2 * Math.PI / kEncoderResolution);
  ...
  public SwerveModule(int i, int j, int k, int l, int m, int n) {
  }
  /**
