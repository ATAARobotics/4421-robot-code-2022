...
public class Teleop {
    ...
    public void teleopInit() {
        ...
        // We don't have to do anything here for setting field oriented to true - auto
        // does that for us
        ...
        swerveDrive.setDefaultCommand(new DriveCommand(swerveDrive, joysticks::getXVelocity, joysticks::getYVelocity,
                joysticks::getRotationVelocity, joysticks::getSpeed, () -> 0.8 * joysticks.getSpeed()));

        Blackbox.getInstance().addLog("Gyro Reading", swerveDrive::getHeading);
        Blackbox.getInstance().addLog("Field Oriented", swerveDrive::getFieldOriented);
        Blackbox.getInstance().addLog("Shooter Speed (Primary)", m_shooterSubsystem::getSpeedPrimary);
        Blackbox.getInstance().addLog("Shooter Speed (Secondary)", m_shooterSubsystem::getSpeedSecondary);
        Blackbox.getInstance().addLog("Shooter Near Setpoint", m_shooterSubsystem::nearSetpoint);
    }
